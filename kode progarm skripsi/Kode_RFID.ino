...
const char *GScriptId = "AKfycbzsQhByUqQUzjkpdMyeRFXLgphPFC8_wCIr3Em2U5ogaKXlZgz_mfBAHodvF9Nk5hJo6A";
String gate_number = "Gate1";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "Ga pernah mati";
const char* password = "1satu1dua";
//---------------------------------------------------------------------------------------------------------
